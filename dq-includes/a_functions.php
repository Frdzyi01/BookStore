...
function dq_title($sep = ' &raquo; ')
{
        ...
        if (isset($_GET['do'])) {
                if ($hack_title) {
                        ...
                        $metas = $post['post_title'] . $sep . get_webinfo('webname');
                } elseif (isset($_GET['language'])) {
                        $metas = get_webinfo('webname');
                } else {
                        $metas = ucwords(str_replace(array('-', '_'), ' ', $_GET['do'])) . $sep . get_webinfo('webname');
                }
                $title = $metas;
                ...
                if ($hack_title) {
                        ...
                        $metas = ucwords(str_replace(array('-', '_'), ' ', $_GET['get'])) . $sep . get_webinfo('webname');
                }
                $title = $metas;
        } elseif (isset($_GET['s'])) {
                if ($hack_title) {
                        ...
                        $metas = 'Search result ' . $_GET['type'] . ' for ' . ucwords(get_search_query()) . $sep . get_webinfo('webname');
                }
                $title = $metas;
        } else {
...
function dq_description($sep = ' - ')
{
        ...
        if (isset($_GET['do'])) {
                if ($hack_description) {
                        $metas = $hack_description;
                } elseif ($post) {
                        $metas = short($post['post_content']) . $sep . get_webinfo('webname');
                } elseif (isset($_GET['language'])) {
                        $metas = get_webinfo('webname');
                } else {
                        $metas = ucwords(str_replace(array('-', '_'), ' ', $_GET['do'])) . $sep . get_webinfo('webdescription');
                }
                $title = $metas;
        } elseif (isset($_GET['get'])) {
                if ($hack_description) {
                        ...
                        $metas = ucwords(str_replace(array('-', '_'), ' ', $_GET['get'])) . $sep . get_webinfo('webdescription');
                }
                $title = $metas;
        } elseif (isset($_GET['s'])) {
                if ($hack_description) {
                        ...
                        $metas = 'Search result ' . $_GET['type'] . ' for ' . get_search_query() . $sep . get_webinfo('webdescription');
                }
                $title = $metas;
        } else {
...
function dq_keywords($sep = ',')
{
        ...
        if (isset($_GET['do'])) {
                if ($hack_keywords) {
                        ...
                        $metas = $post['post_title'];
                } else {
                        $metas = strtolower(str_replace(array('-', '_'), ' ', $_GET['do']));
                }
                ...
                if ($hack_keywords) {
                        ...
                        $metas = strtolower(str_replace(array('-', '_'), ' ', $_GET['get']));
                }
                $title = $metas . $sep . get_webinfo('webkeywords');
        } elseif (isset($_GET['s'])) {
                if ($hack_keywords) {
                        ...
                        $metas = strtolower(get_search_query());
                }
                $title = $metas . $sep . get_webinfo('webkeywords');
        } else {
...
{
        require_once($_SERVER['DOCUMENT_ROOT'] . '/BookStore/dq-admin/badkeyword.php');
...
function watermark_images($oldimage_name, $new_image_name, $width, $height)
{
        ...
        switch ($image_type) {
                case 1:
                        imagegif($im, $new_image_name, 75);
                        break;
                case 2:
                        imagejpeg($im, $new_image_name, 75);
                        break; // best quality
                case 3:
                        imagepng($im, $new_image_name, 7);
