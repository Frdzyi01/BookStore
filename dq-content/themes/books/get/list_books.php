 ...
 * @package deqila.id
 */
$judul_list = ucwords(str_replace(array('_','.',),' ',$_GET['title']));
$hack_title =  $judul_list;
$hack_description = short($hack_title.', All Most Popular '.$judul_list. ' list - ' . $options['webname']);
...
?>
        ...
        <div class="container">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <div class="col-12">
                        <h3 class="heading-small mt-5"><span data-i18n="books.more-books-from"><?php echo $judul_list?></span></h3>
                            <div class="row">
                                <?php 
            						$Books = unserialize( deqila_data_BooksList('list',$_GET['id'],$_GET['title']));
            							 if( is_array($Books) ) { 
