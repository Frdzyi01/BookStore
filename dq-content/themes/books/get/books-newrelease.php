 ...
 * @package deqila.id
 */
$hack_title =  'New Release Books '. date( 'Y' ) . ' - ' . $options['webname'];
$hack_description = short($hack_title.', All New Release Books List');
...
?>
        ...
        <div class="container">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <div class="col-12">
                        <h3 class="heading-small mt-5"><span data-i18n="books.more-books-from">New Release Books</span></h3>
                            <div class="row">
                                <?php 
