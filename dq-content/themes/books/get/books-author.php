 ...
 * @package deqila.id
 */
$hack_title =  'Most Popular Author '. date( 'Y' ) . ' - ' . $options['webname'];
$hack_description = short($hack_title.', All Most Popular Author List');
...
?>
        ...
        <div class="container">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <div class="col-12">
                        <h3 class="heading-small mt-5"><span data-i18n="books.more-books-from">Most Popular Author</span></h3>
                            <div class="row">
                                <?php 
            						    $Books = unserialize( deqila_data_authorbook('on_goodreads'));
            							 if( is_array($Books) ) { 
                                        ...
                                        <div class="thumb__cover">
                                            <div class="cover">
                                                <div class="cover__wrapper">
                                                    <a href="<?php echo seoauthorbooks($item['id'],$item['title']);?>" class="cover__img" style="background-position: 50% 50%;background-size: contain;background-image:url(<?php echo $item['poster'];?> );">
                                                        <img src="<?php echo get_webinfo('theme_url') ;?>img/doc-cover-shadow.png" class="img-fluid"></a>
                                                </div>
                                            </div>    
                                        </div>
                                        <a href="<?php echo seoauthorbooks($item['id'],$item['title']);?>" class="thumb__info" style="text-align:center">
                                            <h1 class="document__title"><?php echo $item['title'];?></h1>
                                            <h2 class="document__subtitle"><?php echo $item['detail'];?></h2>
                                        </a>
                                    </div>
                                 </div>
                                <?php if ($key == 47)break; } } ?>
